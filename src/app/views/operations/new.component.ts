...
@Component({
  ...
  <form class="container" #operationForm="ngForm">
    ...
    <button *ngIf="!operation._id" (click)="saveOperation()" [disabled]="operationForm.invalid">Save</button>
    <button *ngIf="operation._id" (click)="editOperation()" [disabled]="operationForm.invalid">Update</button>
  </form>
  <blockquote>
...
export class NewComponent implements OnInit {
  ...
  @Output() public edit = new EventEmitter<Operation>();
  @Output() public save = new EventEmitter<Operation>();

  public kindsOfOperations = ["Income", "Expense", "Extra"];
